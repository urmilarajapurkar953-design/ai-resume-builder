  ...
  return (
    <>
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto px-4 pt-2">
  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 leading-snug">
    Loved by Users Everywhere
  </h2>

  <p className="mt-3 text-sm sm:text-base md:text-lg text-gray-600">
    Real feedback from people who built their resumes with us. We're constantly improving to give you the best experience.
  </p>
</div>
      </div>
